...
<p>
    На главной странице собраны все активные объявления с основной информацией о машине.
</p>
<p align="center">
...
<p>
    Для каждой машины можно посмотреть всю доступную о ней информацию, а также контакты продавца.
    Создатель объявления может снять машину с продажи в этом разделе.
</p>
<p align="center">
